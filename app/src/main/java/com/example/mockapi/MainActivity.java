...
public class MainActivity extends AppCompatActivity {
    ...
    void setupListview () {
        ...
        AdapterWebFramework adapter = new AdapterWebFramework(this, dataFrameworks);
    ...
    private AdapterView.OnItemClickListener onItemClick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            DataWebFramework fSELECTED = dataFrameworks.get(position);
    ...
    void refreshView() {
        ...
        while(key.hasNext()) {
            ...
            try {
                ...
                dataFrameworks.add(new DataWebFramework(nameFramework, author, official_web, des, img));
